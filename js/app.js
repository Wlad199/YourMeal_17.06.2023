(() => {
    ...
    function calcCartPrice() {
        ...
        if (totalPrice > 0) deliveryBlock.classList.remove("_none"); else deliveryBlock.classList.add("_none");
        if (totalPrice >= 1e3) {
    ...
    function toggleCartCtatus() {
        ...
        if (cartWrapper.children.length > 0) orderForm.classList.remove("_none"); else orderForm.classList.add("_none");
    }
    document.body.addEventListener("click", (function(event) {
        ...
        if (event.target.dataset.action === "minus") {
            const counterWrapper = event.target.closest("[data-counter-wrapper]");
            const counter = counterWrapper.querySelector('[data-current="counter"]');
            if (parseInt(counter.innerText) > 1) counter.innerText = --counter.innerText; else if (event.target.closest(".market-basket") && parseInt(counter.innerText) === 1) {
